...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(JWTUtil jwtUtil, EmployeeUserDetailsService employeeUserDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authenticationManager, JWTUtil jwtUtil) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/ezmanage/auth/**").permitAll()
...
//                        .maximumSessions(1).maxSessionsPreventsLogin(true)  // ae ek user ke liye ek hi session allow karega
                ...
                .addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)  // ae custom JWT authentication filter ko UsernamePasswordAuthenticationFilter se pehle add kar deta h, jisse JWT tokens ko validate kiya ja sake before standard authentication processing
